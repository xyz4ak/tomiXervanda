...
def menu():
    ...
    print((m+"\n["+h+"•"+h+"]"+h+" ID Kamu : "+id))
    print((m+"["+h+"∆"+h+"]"+h+" IP Kamu : "+ip))
    print((m+"["+h+"∆"+h+"]"+h+" Status  : "+u+"IP Lu Jelek Dek"+p))
    print((m+"["+h+"∆"+h+"]"+h+" Waktu  : "+durasi))
    print((p+"\n["+m+"P"+m+"]"+m+" Crack ID Dari Public/FL"))
    print((p+"["+m+"F"+m+"]"+m+" Crack ID Dari Pengikut"))
    print((p+"["+m+"L"+m+"]"+m+" Crack ID Dari Tanggapan Post"))
    print((p+"["+m+"N"+m+"]"+m+" Crack Dar Nomor HP"))
    print((p+"["+m+"E"+m+"]"+m+" Crack Dari Email"))
    print((p+"["+m+"G"+m+"]"+m+" Ambil Data Target"))
    print((p+"["+m+"R"+k+"]"+m+" Hasil Crack"))
    print((u+"["+u+"X"+u+"]"+u+" Keluar"))
    pilih_menu()
...
def pilih_menu():
	...
	if r=="":
		...
		try:
			jalan(k+"\n["+p+"•"+k+"]"+p+" Terimakasih Telah Menggunakan Script Ini")
...
def pilihcrack(file):
  print((k+"\n["+p+"1"+k+"]"+p+" Mbasic ("+h+"Rekomendasi"+p+")"))
